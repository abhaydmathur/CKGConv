...
import ckgconv.metrics_ogb as metrics_ogb
from ckgconv.metric_wrapper import MetricWrapper
...
class CustomLogger(Logger):
    ...
    def regression(self):
        ...
        true, pred = true.float().cpu().numpy(), pred.float().cpu().numpy()
        reformat = lambda x: round(float(x), cfg.round)
        return {
    ...
    def update_stats(
        ...
        if dataset_name == "ogbg-code2":
            ...
            from ckgconv.loader.ogbg_code2_utils import idx2vocab, decode_arr_to_seq
