...
def set_cfg_posenc(cfg):
    ...
    # ----------------- Note: SPD (shortest-path distance) --------------
    cfg.posenc_SPD.enable = False
    cfg.posenc_SPD.ksteps = 21  # maximum distance allowed

    # ------------------ Note: RD (resistance distance) -----
    cfg.posenc_RD.enable = False
